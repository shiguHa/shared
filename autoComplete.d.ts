 ...
 * @param config 
 */
declare function autoComplete(config: IConfiguration): autoComplete;
...
declare class autoComplete {
	...
	init(): void;
	start(query: string);
	serch(query: string, record: string, options: object);
	open(): void;
	next(): void;
	previous(): void;
...
declare module '@tarekraafat/autocomplete.js' {
	...
	export default autoComplete;    //es6 style module export 
}
